...
routes.get('/pokemons/:type', pokemonController.findPokemonByType)
routes.get('/pokemons/:dex', pokemonController.findPokemonByDex)
routes.get('/pokemons/:name', pokemonController.findPokemonByName)
